...
programa
{
	...
	funcao inicio()
	{
		real P = 0.0, M = 0.0, E = 0.0, E_arredondar = 0.0
		escreva("Quantos quilos João está trazendo de tomate? ")
		leia(P)
		se(P > 50) {
			M = 4.0
			E = P - 50
			E_arredondar = mat.arredondar(E, 0)
			M = E_arredondar * M
			escreva("O peso total é " + P + " quilos, a multa aplicada é R$ " + M + " e o excesso é " + E + " quilos.")
		} senao {
			P = 0.0
			escreva("O peso total é " + P + " quilos, a multa aplicada é R$ " + M + " e o excesso é " + E + " quilos.")
		}
